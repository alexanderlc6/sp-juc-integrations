...
/**
 * 系统错误码枚举定义
 *  * 2开头是操作成功代码,200000定义为默认成功状态码
 *  * 4开头是认证失败代码 49100以内是保留数字错误码
 *  * 5开头是系统相关错误 59100以内是保留数字错误码,500000定义为UNKNOWN未知异常的默认错误码
 *  * 60000定义为业务异常的默认错误码
 */
public enum SystemErrorCodeEnum {
    ...
    DUPLICATE_SUBMIT_EXCEPTION(40004,"请耐心等待响应，勿重复提交"),
